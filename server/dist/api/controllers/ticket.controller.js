...
export const createTicket = async (req, res) => {
    try {
        ...
        try {
            broadcastEvent({ type: 'ticket', action: 'created', data: result });
        }
        catch (e) { }
...
export const addMessage = async (req, res) => {
    try {
        ...
        try {
            broadcastEvent({ type: 'ticket', action: 'updated', data: updated });
        }
        catch (e) { }
        res.json(updated);
    }
...
export const adminReopenTicket = async (req, res) => {
    try {
        const { id } = req.params;
...
export const updateTicket = async (req, res) => {
    try {
        ...
        if (!['open', 'replied', 'closed'].includes(normalized))
...
export const adminResetMessaging = async (req, res) => {
    try {
