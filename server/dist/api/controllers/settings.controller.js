...
import { storageBucket, supabase } from "../utils/supabase.js";
...
export const getSettings = async (req, res) => {
    try {
        ...
        res.json({
            ...
            paymentSettings: safeJsonParse(s.paymentMethods, undefined),
            faqs: safeJsonParse(s.faq, []),
        });
    }
    catch (error) {
...
export const updateSettings = async (req, res) => {
    try {
        ...
        if (data.storeName !== undefined)
            updateData.siteName = data.storeName;
        if (data.storeDescription !== undefined)
            updateData.description = data.storeDescription;
        if (data.primaryColor !== undefined)
            updateData.themeColor = data.primaryColor;
        if (data.storePhone !== undefined)
            updateData.phone = data.storePhone;
        if (data.storeEmail !== undefined)
            updateData.email = data.storeEmail;
        if (data.storeDiscordLink !== undefined)
            updateData.discordLink = data.storeDiscordLink;
        ...
        if (data.paymentSettings !== undefined)
            updateData.paymentMethods = JSON.stringify(data.paymentSettings);
        if (data.faqs !== undefined)
            updateData.faq = JSON.stringify(data.faqs);
